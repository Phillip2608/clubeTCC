        ...
        <div class="row p-4 row-cols-1 row-cols-sm-2 g-3 d-flex align-items-center">
            <div class="col">
                ...
                <form action="<?= $router->route("dashboard.documentos"); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card col-2 mx-2 bg-light border border-0">
                ...
                <div class="row">
                    ...
                    <h6 class="row mx-1">Clique para download !</h6>
                    <div class="row">
                        <?php
                        if ($dados['docs'] == null) {
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-1 d-flex justify-content-start">
                                ...
                                ?>
                                            <div class="card col-2 bg-light border border-0 my-2">
                                                ...
                                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalDelete" data-bs-whateverid="<?= $docs->id_documento ?>" data-bs-whatevername="<?= $docs->nm_documento ?>">Excluir</button>
                                            </div>
                                        <?php
        ...
        <div class="modal-dialog" style="width:380px;">
            <div class="modal-content card_header_geral" style="width:380px;">
                ...
                <div class="modal-body">
                    <h6 class="modal-title my-2">Deseja mesmo excluir este arquivo?</h6>
                    <form method="POST" action="<?= $router->route("dashboard.deletDocs"); ?>">
                        <input type="text" id="recipient-id" style="display: none;" name="idDocs">
...
<script>
    ...
    exampleModal.addEventListener('show.bs.modal', function(event) {
        ...
        var recipientName = button.getAttribute('data-bs-whatevername')
        var recipientId = button.getAttribute('data-bs-whateverid')

        var modalName = exampleModal.querySelector('.modal-title')
        var inputId = exampleModal.querySelector('#recipient-id')

        modalName.textContent = recipientName
