                ...
                <div class="col">
                    <div class="card border border-0 bg-light">
                        ...
                        <div class="row row-cols-1 my-2">
                            <div class="col">
                                <h4>Documentos</h4>
                                <div class="nav col-lg-auto d-flex justify-content-start align-items-center my-md-0 text-small">
                                    <?php
                                    if ($dados['docs'] == null) {
                                        echo "<div class='col'><h6>TCC sem documentação!</h6></div>";
                                    } else {
                                        foreach ($dados['docs'] as $documentos) { ?>
                                            <?php
                                            $minusculos = strtolower($documentos->nm_documento);
                                            if ((substr($minusculos, -4) == ".txt") || (substr($minusculos, -4) == ".ppt") || (substr($minusculos, -4) == ".pdf")) {
                                            ?>
                                                <div class="col d-flex justify-content-center align-items-center flex-wrap">
                                                    <div class="d-flex justify-content-center flex-wrap">
                                                        <?php
                                                        if (substr($minusculos, -4) == ".txt") {
                                                        ?>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-file-earmark-font-fill d-block mx-auto mb-1 my-1" viewBox="0 0 16 16">
                                                        ...
                                                        <?php } elseif (substr($minusculos, -4) == ".ppt") {
                                                        ?>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-file-earmark-ppt-fill d-block mx-auto mb-1 my-1" viewBox="0 0 16 16">
                                                        ...
                                                        <?php } elseif (substr($minusculos, -4) == ".pdf") {
                                                        ?>
                                                        ...
                                                        <?php } ?>
                                                        <h6><?php
                                                            if (strlen($minusculos) >= 12) {
                                                                if (substr($minusculos, -4) == ".txt") {
                                                                    $titulo_doc = substr($minusculos, 0, 5);
                                                                    echo $titulo_doc . ".txt";
                                                                } elseif (substr($minusculos, -4) == ".ppt") {
                                                                    $titulo_doc = substr($minusculos, 0, 5);
                                                                    echo $titulo_doc . ".ppt";
                                                                } elseif (substr($minusculos, -4) == ".pdf") {
                                                                    $titulo_doc = substr($minusculos, 0, 5);
                                                                    echo $titulo_doc . ".pdf";
                                                                }
                                                            } else {
                                ...
                                <div class="col d-flex justify-content-center flex-wrap align-items-center text-center">
                                    <div class="card border border-0 bg-light">
                                        ...
                                        <div class="mx-2">
                                            ...
                                            <h6 class="funcao_user"> <?php if ($inter->nm_funcao == null) { echo "Sem função";
                                            } else { echo $inter->nm_funcao; } ?> </h6>
                                        </div>
                                    </div>
