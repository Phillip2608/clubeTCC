				...
				<div class="card-body rounded-2">
					<form class="row justify-content-center" action="<?= $router->route("users.cadastrar"); ?>" method="POST">
						...
						<div class="row my-3 justify-content-center d-flex align-items-center">
							...
							<a href="" class="col-2 btn_redes mx-4 px-2 py-2 shadow d-flex align-items-center justify-content-center text-white rounded-2" id="insta">
								<div>
							...
							<a href="" class="col-2 btn_redes mx-4 px-2 py-2 shadow d-flex align-items-center justify-content-center rounded-2">
								<div>
