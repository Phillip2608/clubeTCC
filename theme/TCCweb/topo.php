  ...
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content modal-content-topo topo">
      ...
      <div class="modal-footer d-flex justify-content-between">
        <a href="<?= URL ?>/configuracao/geral/<?= $_SESSION['id_usuario'] ?>" class="btn botao_cor mx-2">
        ...
        <a href="<?= URL ?>/users/sair" class="btn botao_cor">
          <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
