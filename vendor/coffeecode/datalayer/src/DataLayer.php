...
abstract class DataLayer
{
    ...
    */
     ...
     * @return DataLayer
     */
    public function find(?string $terms = null, ?string $params = null,?string $join = null, string $columns = "*"): DataLayer
    {
        if ($terms) {
            $this->statement = "SELECT {$columns} FROM {$this->entity} {$join} WHERE {$terms}";
